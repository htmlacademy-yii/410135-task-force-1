            ...
            <?php foreach($users as $user)  {?>
                <div class="new-task__card" >
                    <div class="new-task__title" >
                        <a href = "#" class="link-regular" ><h2 > <?= $user->name ?></h2 ></a >
                ...
                <?/*    <b class="new-task__price new-task__price--translation" > <?= $task->cost ?><b > ₽</b ></b >*/?>
                    <p class="new-task__place" > <?= $user->city->name?></p >
                    <span class="new-task__time" >
                            <?

                            $datetime1 = date_create($user->date_add);
                            $datetime2 = date_create('now');
                            $interval = date_diff($datetime1, $datetime2);

                            echo $interval->format('%y лет %m месяцев %d дней %h часов %i минут');?> назад </span >
                </div >
            <?}?>
        </div >
